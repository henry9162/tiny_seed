...
namespace SMW.Migrations
{
    ...
    [Migration("20240512233955_RestructureSubCategories")]
    partial class RestructureSubCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMW.Models.Fabric", b =>
                {
                    ...
                    b.Property<int?>("FabricSubCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FabricSubCategoryId");
            ...
            modelBuilder.Entity("SMW.Models.Style", b =>
                {
                    ...
                    b.Property<int?>("StyleSubCategoryId")
                        .IsRequired()
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("StyleSubCategoryId");
            ...
            modelBuilder.Entity("SMW.Models.Fabric", b =>
                {
                    b.HasOne("SMW.Models.FabricSubCategory", "FabricSubCategory")
                        .WithMany("Fabrics")
                        .HasForeignKey("FabricSubCategoryId");

                    b.Navigation("FabricSubCategory");
                });
            ...
            modelBuilder.Entity("SMW.Models.Style", b =>
                {
                    b.HasOne("SMW.Models.StyleSubCategory", "StyleSubCategory")
                        .WithMany("Styles")
                        .HasForeignKey("StyleSubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StyleSubCategory");
                });
